...
#   description = "Security group for user-service with custom ports open within VPC,  egress all traffic"
...
module "sg" {
  ...
  source = "git::https://github.com/PradeepReddy927/terraform-aws-sg.git?ref=main"
